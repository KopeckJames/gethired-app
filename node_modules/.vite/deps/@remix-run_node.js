import {
  esm_exports,
  init_esm
} from "./chunk-CWM4SDEQ.js";
import {
  require_safe_buffer
} from "./chunk-F4KP6457.js";
import {
  require_crypto,
  require_stream,
  require_util
} from "./chunk-B5FQGG25.js";
import {
  __commonJS,
  __esm,
  __export,
...
// browser-external:node:util/types
var require_types = __commonJS({
  "browser-external:node:util/types"(exports, module) {
    module.exports = Object.create(new Proxy({}, {
      get(_, key) {
        if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") {
          console.warn(`Module "node:util/types" has been externalized for browser compatibility. Cannot access "node:util/types.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
        }
      }
    }));
  }
...
var require_util3 = __commonJS({
  "node_modules/undici/lib/web/fetch/util.js"(exports, module) {
    ...
    var { isBlobLike, ReadableStreamFrom: ReadableStreamFrom2, isValidHTTPToken, normalizedMethodRecordsBase } = require_util2();
    var assert = require_node_assert();
    ...
    function isReadableStreamLike2(stream) {
    ...
    module.exports = {
      ...
      fullyReadBody,
      bytesMatch,
      isReadableStreamLike: isReadableStreamLike2,
      readableStreamClose,
      isomorphicEncode,
      urlIsLocal,
      urlHasHttpsScheme,
...
var require_file = __commonJS({
  "node_modules/undici/lib/web/fetch/file.js"(exports, module) {
    "use strict";
    var { Blob: Blob2, File: File2 } = require_node_buffer();
...
var require_body = __commonJS({
  "node_modules/undici/lib/web/fetch/body.js"(exports, module) {
    ...
    function extractBody(object, keepalive = false) {
      ...
      assert(isReadableStreamLike2(stream));
      let action = null;
      let source = null;
      let length = null;
      let type = null;
        ...
        if (channels.connected.hasSubscribers) {
          channels.connected.publish({
            connectParams: {
              ...
              protocol,
              port,
              version: (_b2 = client[kHTTPContext]) == null ? void 0 : _b2.version,
              servername: client[kServerName],
              localAddress: client[kLocalAddress]
            },
            connector: client[kConnector],
        ...
        if (channels.connectError.hasSubscribers) {
          channels.connectError.publish({
            connectParams: {
              ...
              protocol,
              port,
              version: (_c2 = client[kHTTPContext]) == null ? void 0 : _c2.version,
              servername: client[kServerName],
              localAddress: client[kLocalAddress]
            },
            connector: client[kConnector],
...
var require_readable = __commonJS({
  "node_modules/undici/lib/api/readable.js"(exports, module) {
    ...
    var util = require_util2();
    var { ReadableStreamFrom: ReadableStreamFrom2 } = require_util2();
  ...
  "node_modules/undici/lib/api/abort-signal.js"(exports, module) {
    ...
    function abort(self2) {
      ...
      if (self2.abort) {
        ...
        self2.reason = ((_b2 = self2[kSignal]) == null ? void 0 : _b2.reason) ?? new RequestAbortedError();
      }
      removeSignal(self2);
    }
  ...
  "node_modules/undici/lib/mock/mock-utils.js"(exports, module) {
    ...
    function mockDispatch(opts, handler) {
      ...
      function handleReply(mockDispatches, _data = data) {
        ...
        (_b2 = handler.onHeaders) == null ? void 0 : _b2.call(handler, statusCode, responseHeaders, resume, getStatusText(statusCode));
...
var require_decorator_handler = __commonJS({
  "node_modules/undici/lib/handler/decorator-handler.js"(exports, module) {
    ...
    module.exports = (_a2 = class {
      ...
      onConnect(...args) {
        var _a3, _b2;
        return (_b2 = (_a3 = __privateGet(this, _handler)).onConnect) == null ? void 0 : _b2.call(_a3, ...args);
      }
      onError(...args) {
        var _a3, _b2;
        return (_b2 = (_a3 = __privateGet(this, _handler)).onError) == null ? void 0 : _b2.call(_a3, ...args);
      }
      onUpgrade(...args) {
        var _a3, _b2;
        return (_b2 = (_a3 = __privateGet(this, _handler)).onUpgrade) == null ? void 0 : _b2.call(_a3, ...args);
      }
      onResponseStarted(...args) {
        var _a3, _b2;
        return (_b2 = (_a3 = __privateGet(this, _handler)).onResponseStarted) == null ? void 0 : _b2.call(_a3, ...args);
      }
      onHeaders(...args) {
        var _a3, _b2;
        return (_b2 = (_a3 = __privateGet(this, _handler)).onHeaders) == null ? void 0 : _b2.call(_a3, ...args);
      }
      onData(...args) {
        var _a3, _b2;
        return (_b2 = (_a3 = __privateGet(this, _handler)).onData) == null ? void 0 : _b2.call(_a3, ...args);
      }
      onComplete(...args) {
        var _a3, _b2;
        return (_b2 = (_a3 = __privateGet(this, _handler)).onComplete) == null ? void 0 : _b2.call(_a3, ...args);
      }
      onBodySent(...args) {
        var _a3, _b2;
        return (_b2 = (_a3 = __privateGet(this, _handler)).onBodySent) == null ? void 0 : _b2.call(_a3, ...args);
      }
    }, _handler = new WeakMap(), _a2);
  }
});
  ...
  "node_modules/undici/lib/web/fetch/request.js"(exports, module) {
    ...
    var Request = class _Request {
      ...
      constructor(input, init = {}) {
        ...
        let window = "client";
        if (((_b2 = (_a2 = request.window) == null ? void 0 : _a2.constructor) == null ? void 0 : _b2.name) === "EnvironmentSettingsObject" && sameOrigin(request.window, origin)) {
  ...
  "node_modules/undici/lib/web/fetch/index.js"(exports, module) {
    ...
    function fetching({
      ...
      if (request.window === "client") {
        request.window = ((_c2 = (_b2 = (_a2 = request.client) == null ? void 0 : _a2.globalObject) == null ? void 0 : _b2.constructor) == null ? void 0 : _c2.name) === "Window" ? request.client : "no-window";
      }
...
var require_undici = __commonJS({
  "node_modules/undici/index.js"(exports, module) {
    ...
    module.exports.File = globalThis.File ?? require_node_buffer().File;
